...
for i = 1:sizepop
    ...
    [pop_fs(i,:),pop_cfier(i,:)] = param_adjust(data,pop_fs(i,:),pop_cfier(i,:),...
            fs_param_range,cfier_param_range,fs_ps_ind,cfier_ps_ind);
    fitness(i) = ps_classify(data,label,train_idx,test_idx,pop_fs(i,:),pop_cfier(i,:));
end
...
for i = 1:maxgen
    for j = 1:sizepop
        ...
        [pop_fs(j,:),pop_cfier(j,:)] = param_adjust(data,pop_fs(j,:),pop_cfier(j,:),...
            fs_param_range,cfier_param_range,fs_ps_ind,cfier_ps_ind);
...
function [pop_fs_adjusted,pop_cfier_adjusted] = ...
    param_adjust(data,pop_fs,pop_cfier,...
    fs_param_range,cfier_param_range,fs_ps_ind,cfier_ps_ind)
